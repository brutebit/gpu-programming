...
int main(int argc, char *argv[])
{
    ...
    GLFWwindow* window = glfwCreateWindow(600, 600, "Sample 007", nullptr, nullptr);
...
void display()
{
    ...
    GLint offsetLocation = glGetUniformLocation(renderingProgram, "offset");   // get pointer to offset
    glProgramUniform1f(renderingProgram, offsetLocation, x);                   // send value in x to offset
